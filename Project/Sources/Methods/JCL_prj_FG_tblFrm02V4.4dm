...
//C_LONGINT($offset)
//C_OBJECT($foreignParam)
//$foreignParam:=New object
//C_TEXT($tblName; $tbl_prefix)
//ARRAY LONGINT($aryTblNr; 0)
//ARRAY TEXT($aryForeignKeys; 0)
//ARRAY TEXT($aryFieldIndex; 0)
//$cnt:=zz_tbl_FindForeignKey($objParam.tbl_name; ->$aryTblNr; ->$aryForeignKeys)
//For ($i; 1; $cnt)
//$tblName:=Table name($aryTblNr{$i})
...
//ARRAY TEXT($aryFieldLength; 0)  //文字長さの配列
